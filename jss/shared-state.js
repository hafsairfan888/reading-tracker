...
// every other script file relies on. Must load before any of those other
// files in index.html - they all read from the variables defined here.
// (color-picker.js is the one exception: it's a self-contained component
// that doesn't touch this file's variables, so it's fine to load first.)
