...
│   ├── toolbar.css             Top toolbar (save/open)
...
└── js/
    ├── shared-state.js         Central state + cached DOM lookups (loads first)
    ...
    ├── save-load.js            Save/Save As/Open — reads and writes draft JSON
...
Use **Save** / **Save As** in the toolbar to write your draft to a local JSON file, and **Open** to load one back in — your indicators and segments are preserved so you can pick up where you left off.
